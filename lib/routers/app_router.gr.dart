  ...
  final Map<String, _i19.PageFactory> pagesMap = {
    CoreMunicipalityRoute.name: (routeData) {
      ...
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child:
            _i19.WrappedRoute(child: _i1.CoreMunicipalityPage(key: args.key)),
      );
    },
    ...
    EventListRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i19.WrappedRoute(child: const _i4.EventListPage()),
      );
    },
    ...
    IssuesListRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i19.WrappedRoute(child: const _i6.IssuesListPage()),
      );
    },
    ...
    NewIssueRouter.name: (routeData) {
      ...
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i19.WrappedRoute(child: _i9.NewIssuePager(key: args.key)),
      );
    },
    ...
    NewsListRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i19.WrappedRoute(child: const _i11.NewsListPage()),
      );
    },
...
/// generated route for
/// [_i14.PnrrServicesPage]
class PnrrServicesRoute extends _i19.PageRouteInfo<PnrrServicesRouteArgs> {
  PnrrServicesRoute({
    _i21.Key? key,
  ...
  static const _i19.PageInfo<PnrrServicesRouteArgs> page =
      _i19.PageInfo<PnrrServicesRouteArgs>(name);
}
