...
class _MunicipalityService implements MunicipalityService {
  ...
  Future<MunicipalityDTO> getMunicipality(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MunicipalityDTO>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late MunicipalityDTO _value;
    try {
      _value = MunicipalityDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<DashboardMenu>> getMunicipalityDashboard(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<DashboardMenu>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '${baseUrl}/municipalities/dashboard_mobile/${municipalityId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<DashboardMenu> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => DashboardMenu.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
