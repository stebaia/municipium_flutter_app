...
part of 'civil_defence_service.dart';
...
class _CivilDefenceService implements CivilDefenceService {
  ...
  Future<CivilDefenceLevels> getCivilDefenceLevels(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CivilDefenceLevels>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<CivilDefenceListInformations>> getCivilDefenceInformations(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CivilDefenceListInformations>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '${baseUrl}/civil_defence_informations',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<CivilDefenceListInformations> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              CivilDefenceListInformations.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
