...
class _GarbageService implements GarbageService {
  _GarbageService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<List<PoiDetailDTO>> getRecyclingAreas(String baseUrl) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PoiDetailDTO>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
