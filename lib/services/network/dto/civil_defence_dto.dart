class CivilDefenceDTO {
	...
	CivilDefenceDTO({this.civilDefencePhoneNumbers, this.civilDefenceLevels, this.civilDefenceAlertsNews, this.civilDefenceInformations, this.civilDefenceAreYouReady});
