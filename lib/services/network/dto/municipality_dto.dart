...
class MunicipalityDTO extends DTO with EquatableMixin {
  ...
  bool? disableImage;
  bool? searchStreet;
  String? prenotationWebUrl;

  MunicipalityDTO(
      {this.issueUrl,
      this.prefix,
      this.googlePlusLink,
      this.conciliaSandbox,
      this.enableEnhancedIssues,
      this.zipCode,
      this.siteHeaderLogoType,
      this.pec,
      this.youtubeLink,
      this.province,
      this.draft,
      ...
      this.fax,
      this.nuovoBo,
      this.enableSpontaneo,
      this.vatCode,
      this.enableAuthentication,
      this.surface,
      this.eventsRepeating,
      this.active,
      this.serviceProvider,
      this.serviceIndexEidas,
      this.siteBoxColor,
      this.serviceLabel,
      this.enableLdap,
      this.sandboxClientId,
      this.phone,
      this.surveyLoginCode,
      this.iban,
      this.jcityGovIntegration,
      this.linkedinLink,
      this.civilDefencePointOfInterestCategoryIds,
      this.itineraryEnabled,
      this.emergenzaSordi,
      this.codiceCatastale,
      this.roundedImage,
      this.serviceProviderCieid,
      this.latitude,
      this.facebookLink,
      this.civilDefenceNewsCategoryIds,
      this.isChild,
      this.skype,
      this.recaptchaSecretKey,
      this.accessibilityCode,
      this.jcityGovEnte,
      this.paymentLoginCode,
      this.headerUrl,
      this.enableIssues,
      this.email,
      this.firstScript,
      this.digitalDossierServices,
      this.issueDescription,
      this.authLevelCieid,
      this.address,
      this.languages,
      this.enablePagamento,
      this.headerName,
      this.menu,
      this.enableAvviso,
      this.civilDefenceType,
      this.issueStatistics,
      this.jcityGovUrl,
      this.provinceId,
      this.siteHeaderTitleType,
      this.privateSection,
      this.newsRepeating,
      this.serviceIndex,
      this.enableGarbageCalendar,
      this.importSportello,
      this.siteTemplate,
      this.numberFaq,
      this.twitterLink,
      this.enableFaq,
      ...
      this.codiceSap,
      this.appService4,
      this.conciliaEnabled,
      this.evaluationFormLink,
      this.instagramLink,
      this.conciliaServerIp,
      this.idGallery,
      this.logo,
      this.eventHomepageTemplate,
      this.clientSecret,
      this.slug,
      this.longitude,
      this.citizensNumber,
      this.displayEventsCalendar,
      this.image,
      this.bannerVisible,
      this.conciliaCustomerCode,
      this.enableRegistration,
      this.gdprEnabled,
      this.penalityOnlineStampDuty,
      this.tax,
      this.siteHeaderTitle,
      this.pagopaEnabled,
      this.recaptchaKey,
      this.background,
      this.name,
      ...
      this.description,
      this.fiscalCode,
      this.customMenuServices,
      this.conciliaServerPort,
      this.newsIdForeground,
      this.enableEvaluate,
      this.analyticsTrackingCode,
      this.urlDms,
      this.issuesLoginCode,
      this.pagopaCodiceTipoDebito,
      this.deafEmergency,
      this.galleryMosaic,
      this.isAggregator,
      this.urlSportello,
      ...
      this.siteHeaderColor,
      this.countPrenotazioni,
      this.paypalEnabled,
      this.topBlocks,
      this.cookiePolicyActive,
      this.disableImage,
      this.searchStreet,
      this.prenotationWebUrl});
  ...
  MunicipalityDTO.fromJson(Map<String, dynamic> json) {
    try {
      ...
      province = json['province'] != null
          ? new ProvinceDTO.fromJson(json['province'])
          : null;
      draft = json['draft'];
      ...
      civilDefencePointOfInterestCategoryIds =
          json['civil_defence_point_of_interest_category_ids']?.cast<int>();
      ...
      civilDefenceNewsCategoryIds =
          json['civil_defence_news_category_ids']?.cast<int>();
      ...
      digitalDossierServices = json['digital_dossier_services'] != null
          ? DigitalDossierServicesDTO.fromJson(json['digital_dossier_services'])
          : null;
      ...
      privateSection = json['private_section'] != null
          ? PrivateSectionDTO.fromJson(json['private_section'])
          : null;
      ...
      newMenu = json['new_menu'] != null
          ? NewMenuDTO.fromJson(json['new_menu'])
          : null;
      clientId = json['client_id'];
      siteLogo = json['site_logo'] != null
          ? MImagesDTO.fromJson(json['site_logo'])
          : null;
      appService1 = json['app_service_1'];
      features = json['features'] != null
          ? FeaturesDTO.fromJson(json['features'])
          : null;
      ...
      background = json['background'] != null
          ? MImagesDTO.fromJson(json['background'])
          : null;
      name = json['name'];
      subdomain = json['subdomain'];
      region =
          json['region'] != null ? ProvinceDTO.fromJson(json['region']) : null;
      istat = json['istat'];
      ...
      if (json['custom_menu_services'] != null) {
        ...
        json['custom_menu_services'].forEach((v) {
          customMenuServices!.add(CustomMenuServicesDTO.fromJson(v));
        });
      }
      ...
      frontendPermissions = json['frontend_permissions'] != null
          ? FrontendPermissionsDTO.fromJson(json['frontend_permissions'])
          : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['civil_defence_point_of_interest_category_ids'] =
        this.civilDefencePointOfInterestCategoryIds;
    ...
    if (this.customMenuServices != null) {
      data['custom_menu_services'] =
          this.customMenuServices!.map((v) => v.toJson()).toList();
    }
    ...
    data['url_prenotazioni_web'] = this.prenotationWebUrl;
    return data;
  }
