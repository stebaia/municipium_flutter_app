...
class GarbageCalendars extends Equatable {
	...
	GarbageCalendars({required this.id, required this.name, required this.updatedAt, required this.zone, required this.calendarTypeName, required this.calendarTypeIcon, required this.calendarTypeIconGrey});
