      ...
      builder: (context, state) {
        ...
        return Stack(
              ...
              Positioned.fill(
                child: GoogleMap(
                  ...
                  initialCameraPosition: CameraPosition(
                      zoom: 14,
                      target: LatLng(municipality.lat, municipality.lng)),
            ...
            builder: ((modalContext) => CustomBaseBottomSheet(
                ...
                title: 'filtri',
                body: FilterModalBottomSheet(categorySelectionCubit: context.read(), pointOfInterestListBloc: context.read(),)))),
                        child: Container(
                            ...
                            child: const Center(child: FaIcon(FontAwesomeIcons.sliders, size: 18,))),
                      ),
