...
@RoutePage()
class GarbageReciclingAreasPage extends StatelessWidget
      ...
      body: BlocBuilder<RecyclingAreasBloc, RecyclingAreasState>(
        builder: (context, state) {
          if (state is FetchedRecyclingAreasState) {
            return ListView.builder(
              ...
              itemBuilder: ((context, index) => Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(state.recyclingAreas[index].name!, style: Theme.of(context).textTheme.titleMedium),
                        subtitle:
                            Text(state.recyclingAreas[index].address!, style: Theme.of(context).textTheme.bodySmall),
            ...
            return Center(
              child: Text(AppLocalizations.of(context)!.text_no_recycling_in_list),
            );
          }
        },
      ),
