...
typedef BaseUrlSelectorWidgetBuilder = Widget Function(
    BuildContext, BaseUrlType);
...
class BaseUrlSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<BaseUrlCubit, BaseUrlState>(
      builder: (context, state) =>
          builder(context, state.prod ? BaseUrlType.prod : BaseUrlType.staging),
    );
  }
}
